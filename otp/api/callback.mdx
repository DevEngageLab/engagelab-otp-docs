---
title: "Webhook Callbacks — OTP Delivery & Verification Events"
...
| Field Name | Type | Description |
| --- | --- | --- |
| `action` | string | Possible values: `create api_key` (create API Key), `update api_key` (update API Key), `delete api_key` (delete API Key), `view api_secret` (view API Secret) |
